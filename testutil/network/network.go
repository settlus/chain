...
func DefaultConfig() Config {
	...
	chainID := fmt.Sprintf("settlus_%d-1", tmrand.Int63n(9999999999999)+1)
	...
	return Config{
		...
		AccountTokens:     sdk.TokensFromConsensusPower(100000, evmostypes.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(50000, evmostypes.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(10000, evmostypes.PowerReduction),
		PruningStrategy:   pruningtypes.PruningOptionNothing,
		CleanupDir:        true,
		SigningAlgo:       string(hd.EthSecp256k1Type),
		KeyringOptions:    []keyring.Option{hd.EthSecp256k1Option()},
		PrintMnemonic:     false,
		JSONRPCAddress:    config.DefaultJSONRPCAddress,
	}
}
