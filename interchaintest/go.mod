module github.com/settlus/chain/interchaintest

go 1.21

require github.com/cosmos/cosmos-sdk v0.46.13
...
require (
	...
	github.com/strangelove-ventures/interchaintest/v6 v6.0.0 // indirect
