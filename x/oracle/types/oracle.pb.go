...
type OracleTopic int32

const (
	// DEPRECATED: Do not use.
	OracleTopic_BLOCK OracleTopic = 0
	// Ownership defines nft ownership consensus.
	OracleTopic_OWNERSHIP OracleTopic = 1
)

var OracleTopic_name = map[int32]string{
	0: "BLOCK",
	1: "OWNERSHIP",
}

var OracleTopic_value = map[string]int32{
	"BLOCK":     0,
	"OWNERSHIP": 1,
}

func (x OracleTopic) String() string {
	return proto.EnumName(OracleTopic_name, int32(x))
}

func (OracleTopic) EnumDescriptor() ([]byte, []int) {
...
type VoteData struct {
	Topic OracleTopic `protobuf:"varint,1,opt,name=topic,proto3,enum=settlus.oracle.v1alpha1.OracleTopic" json:"topic,omitempty"`
...
func (m *VoteData) GetTopic() OracleTopic {
	if m != nil {
		return m.Topic
	}
	return OracleTopic_BLOCK
}
...
type RoundInfo struct {
	...
	Ownerships []string `protobuf:"bytes,4,rep,name=ownerships,proto3" json:"ownerships,omitempty"`
...
func (m *RoundInfo) GetOwnerships() []string {
	if m != nil {
		return m.Ownerships
	}
	return nil
...
func init() {
	proto.RegisterEnum("settlus.oracle.v1alpha1.OracleTopic", OracleTopic_name, OracleTopic_value)
...
var fileDescriptor_787227b110a6eeb7 = []byte{
	...
	,
}
...
func (m *RoundInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Ownerships) > 0 {
		for iNdEx := len(m.Ownerships) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Ownerships[iNdEx])
			copy(dAtA[i:], m.Ownerships[iNdEx])
			i = encodeVarintOracle(dAtA, i, uint64(len(m.Ownerships[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Topic |= OracleTopic(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RoundInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ownerships", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Ownerships = append(m.Ownerships, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
