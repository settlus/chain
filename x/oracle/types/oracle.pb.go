...
type RoundInfo struct {
	...
	PrevoteEnd uint64   `protobuf:"varint,2,opt,name=prevote_end,json=prevoteEnd,proto3" json:"prevote_end,omitempty"`
	VoteEnd    uint64   `protobuf:"varint,3,opt,name=vote_end,json=voteEnd,proto3" json:"vote_end,omitempty"`
...
func (m *RoundInfo) GetPrevoteEnd() uint64 {
	if m != nil {
		return m.PrevoteEnd
	}
	return 0
...
func (m *RoundInfo) GetVoteEnd() uint64 {
	if m != nil {
		return m.VoteEnd
	}
	return 0
...
func (m *RoundInfo) GetChainIds() []string {
	if m != nil {
		return m.ChainIds
	}
	return nil
...
var fileDescriptor_787227b110a6eeb7 = []byte{
	...
	,
}
...
func (m *RoundInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChainIds) > 0 {
		for iNdEx := len(m.ChainIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintOracle(dAtA, i, uint64(len(m.ChainIds[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrevoteEnd |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
